...
export default function ThemeInfo() {
  ...
  const magentoThemeInfo = useSelector((state) => state.magentoThemeInfo);
  const loading = useSelector((state) => state.loading);

  useEffect(() => {
    axios
      .get("/api/magento/affiliate-db")
      .then((res) => setThemeAffiliate(res.data));
    axios
      .get("/api/magento/theme-info-component")
              ...
              >
                <CardBody>
                  <div className="space-y-5 max-w-4xl mx-auto text-center z-50">
                    ...
                    >
                      This Magento site using the theme
                    </h2>
                    <h2 className="text-4xl font-extrabold mx-auto md:text-6xl text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5] pb-3 text-center">
                      {magentoThemeInfo?.data?.themeInfo[0]
                        ?.split(/[ -]/)
          ...
          <div className="mt-8 flex justify-center">
            ...
            >
              <Image
                src={
                  magentoThemeInfo?.status
                    ? magentoThemeInfo?.data?.screenShot[0]
