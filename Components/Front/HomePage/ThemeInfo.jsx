...
export default function ThemeInfo() {
  ...
  useEffect(() => {
    axios
      .get("/api/wp-theme-detector/affiliate-db")
      .then((res) => setThemeAffiliate(res.data));
    axios
      .get("/api/wp-theme-detector/theme-info-component")
              ...
              >
                <CardBody>
                  <div className="space-y-5 max-w-4xl mx-auto text-center z-50">
                    ...
                    >
                      This WordPress site using the theme
                    </h2>
