      ...
      <div className="flex w-full flex-col">
        <Tabs aria-label="Options" size="lg" radius="md" fullWidth>
          <Tab key="stats_1" title="Stats 1">
            <AdminStats_1 dbCollection={"wp-theme-detector"} item={"stats_1"} />
          </Tab>
          <Tab key="stats_2" title="Stats 2">
            <AdminStats_2 dbCollection={"wp-theme-detector"} item={"stats_2"} />
          </Tab>
          <Tab key="stats_3" title="Stats 3">
            <AdminStats_3 dbCollection={"wp-theme-detector"} item={"stats_3"} />
          </Tab>
          <Tab key="stats_4" title="Stats 4">
            <AdminStats_4 dbCollection={"wp-theme-detector"} item={"stats_4"} />
          </Tab>
          <Tab key="stats_5" title="Stats 5">
            <AdminStats_5 dbCollection={"wp-theme-detector"} item={"stats_5"} />
          </Tab>
          <Tab key="stats_6" title="Stats 6">
            <AdminStats_6 dbCollection={"wp-theme-detector"} item={"stats_6"} />
          </Tab>
          <Tab key="stats_7" title="Stats 7">
            <AdminStats_7 dbCollection={"wp-theme-detector"} item={"stats_7"} />
          </Tab>
        </Tabs>
      </div>
    </Card>
