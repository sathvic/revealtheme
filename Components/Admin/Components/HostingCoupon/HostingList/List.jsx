                  ...
                  <div className="mt-3 lg:mt-0 flex flex-col justify-center items-center">
                    ...
                    <div className="relative my-4">
                      <Button
                        ...
                        size="md"
                        radius="md"
                        className="text-xl font-bold text-white absolute card2-bg"
                      ...
                      <Button
                        ...
                        size=""
                        radius="md"
                        className="text-sm font-bold text-white card1-bg hover:bg-green-600 -translate-x-6 hover:-translate-x-10"
                        onClick={() => showCoupon(x)}
                      >
                        Show Code
                      </Button>
