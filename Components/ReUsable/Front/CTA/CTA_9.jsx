            ...
            <div className="mx-auto">
              ...
              >
                ...
                <div className="relative pb-3/5 -mt-6 md:pb-1/2">
                  <img
                    className="absolute inset-0 w-full h-full transform translate-x-6 translate-y-6 rounded-md object-fill object-left-top sm:translate-x-10 lg:translate-y-20"
                    src={
