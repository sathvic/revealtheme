      ...
      {data?.enable && (
        <div className="relative">
          ...
          <div className="flex flex-1 w-full flex-col items-cente justify-cente text-center px-4 lg:py-20 2xl:py-52 bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 h-screen">
            ...
            <div className="relativ w-full  mx-auto text-center px-1 md:px-40 2xl:px-52">
              <div className="flex flex-col items-center justify-center gap-3 mt-10 sm:flex-row  mx-auto 2xl:max-w-6xl">
                <form
                  onSubmit={handleSubmit}
                  className=" w-full bg-slate-300 dark:bg-white/20  p-1.5 sm:p-3 rounded-2xl"
                >
                  <div className="w-full lg:flex lg:items-center lg:justify-between ">
                    ...
                    <button
                      className="w-full lg:w-auto 0 active:bg-slate-600 active:text-white/80 before:transition-colors bg-white flex-none font-medium hover:bg-indigo-900 hover:text-white inline-flex justify-center lg:ml-4 outline-2 outline-offset-2 px-16 py-2.5 sm:py-4 relative rounded-xl text-indigo-500"
                      type="submit"
                    >
