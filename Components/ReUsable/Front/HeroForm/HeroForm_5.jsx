      ...
      {data?.enable && (
        <>
          ...
          <div className="overflow-hidden min-h-screen anim-bg ">
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-20 2xl:py-52">
              <div className="relative mx-auto max-w-4xl grid space-y-5 2xl:space-y-10">
                <div className="text-center ">
                  ...
                  <h1 className="text-3xl text-gray-100 font-bold sm:text-5xl lg:text-6xl 2xl:text-7xl lg:leading-tight dark:text-gray-100">
                    {data?.mainTitle?.split(".")[0] ||
                      "Turn online shoppers into"}{" "}
                  </h1>
                  <h1 className="text-3xl sm:text-5xl lg:text-6xl 2xl:text-7xl font-bold lg:leading-light text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5]">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mx-auto max-w-4xl 2xl:max-w-6xl sm:flex sm:space-x-3 p-3 bg-gray-300 rounded-3xl shadow-lg  dark:bg-gray-900 dark:border-gray-700 dark:shadow-gray-900/[.2] flex flex-col sm:flex-row align-center">
                    <input
                      required
                      value={value}
                      onChange={(e) => setValue(e.target.value)}
                      type="text"
                      className="block w-full p-3 text-gray-600 dark:text-gray-200 bg-transparent border border-transparent appearance-none rounded-2xl focus:border-gray-400 focus:outline-none focus:ring-slate-500 dark:placeholder:text-slate-300 sm:text-lg"
                    ...
                    <div className="pt-2 sm:pt-0 grid   sm:block sm:flex-[0_0_auto]">
                      <button
                        type="submit"
                        className="py-3 px-4 inline-flex justify-center items-center gap-2  border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm sm:py-5 sm:px-16 dark:focus:ring-offset-gray-800 rounded-2xl"
                        // href="#"
                      >
